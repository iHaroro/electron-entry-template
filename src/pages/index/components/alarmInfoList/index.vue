...
import rightArrIcon from '@/pages/index/assets/images/arr_right_icon.png'
import empty from '@/pages/index/components/empty/index.vue'
import Dialog from '@/pages/index/components/dialog/index.vue'
import { setAlarmRead } from '@/pages/index/api/monitor.js'
