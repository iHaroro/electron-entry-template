  ...
  <div class="login-page">
    ...
    <div class="right-box">
      ...
      <div class="title-box">
        ...
        <div class="title-box-desc">船舶智能监控系统</div>
      </div>
      ...
      <div class="form-box">
        ...
        <div class="input-box">
          ...
          />
          <div class="password-control-box" @click="toggleShowPassword">
            <EyeOutlined v-show="!isShowPassword" />
            <EyeInvisibleOutlined v-show="isShowPassword" />
          </div>
        </div>
        <a-button
...
import { useLoginControl } from '@/pages/monitor/stores/loginControl.js'
import { setTokenToApplication } from '@/pages/monitor/utils/userInfo.js'
import { handlerPromise } from '@/pages/monitor/utils/utils.js'
...
const { loginAction } = useLoginControl()
/**
...
const loginHandler = async () => {
  ...
  if (!userAccount) {
    ...
    const [loginErr, loginRes] = await handlerPromise(loginAction({ userAccount: userAccount, password: password }))
...
.login-page {
  ...
  .left-box {
    ...
    width: vw(1236);
    height: 100%;
    background-image: url('@/pages/monitor/assets/images/login_bg.jpg');
    ...
    &::after {
      ...
      width: vw(9);
      height: 100%;
      background-image: url('@/pages/monitor/assets/images/split_bg.png');
  ...
  .right-box {
    ...
    .title-box {
      ...
      background-image: url('@/pages/monitor/assets/images/login_title_bar_bg.png');
