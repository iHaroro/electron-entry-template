...
import titleComponent from '@/pages/monitor/components/titleComponent'
...
.dialog-box {
  ...
  .dialog-title-box {
    ...
    .close-btn {
      ...
      width: vw(24);
      height: vw(24);
      background: url('@/pages/monitor/assets/images/dialog_close_icon.png') no-repeat center center;
