...
import {
  ...
  EMIT_EVENT_MAP,
  HANDLE_EVENT_MAP,
} from '@/pages/index/utils/map.js'
import { debugLog, objectToQuery } from '@/pages/index/utils/utils.js'
import { getBrowserLocation } from '@/pages/index/utils/navigator.js'
import { message } from 'ant-design-vue'
import { debounce } from 'lodash'
import { BOAT_INFO } from '@/pages/index/provide/boat.js'
import shipTools from '@/pages/index/components/shipTools/index.vue'
