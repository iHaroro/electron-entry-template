...
import dashboardCompass from '@/pages/index/components/dashboardCompass/index.vue'
import dashboardCompassEmpty from '@/pages/index/components/dashboardCompassEmpty/index.vue'
