<template>
  <div class="copilot-ezui-player-box">
 ...
 **/
const initPlayer = () => {
  UIKitDEMO = new EZUIKit.EZUIKitPlayer({
    id: eleId,
    url: props.url,
...
const changeVideoLevel = () => {
  console.log('change video level', UIKitDEMO, defaultQuality)
  if (defaultQuality !== null) return
  const qualityList = UIKitDEMO?.getVideoLevelList() || []
  defaultQuality =
